...
/* harmony import */ var _parts_app_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./parts/app.js */ "./src/js/parts/app.js");
/* harmony import */ var _parts_plugins_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./parts/plugins.js */ "./src/js/parts/plugins.js");
/* harmony import */ var _parts_parts_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./parts/parts.js */ "./src/js/parts/parts.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(function () {
  ...
  window.app = new _parts_app_js__WEBPACK_IMPORTED_MODULE_3__.App();
  window.app.init();
  window.plugins = new _parts_plugins_js__WEBPACK_IMPORTED_MODULE_4__.Plugins();
  window.plugins.init();
  window.parts = new _parts_parts_js__WEBPACK_IMPORTED_MODULE_5__.Parts();
  window.parts.init();
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
  var sticky = jquery__WEBPACK_IMPORTED_MODULE_0___default()(".main-header"),
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#close-product-btn").click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#product-modal").addClass("d-none");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").removeClass("overflow-hidden");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".single-basket").click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".offcanvas-body-left").removeClass("d-none");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").addClass("overflow-hidden");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".close-basket").click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".offcanvas-body-left").addClass("d-none");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("html").removeClass("overflow-hidden");
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-show").click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()("#search-dropdown").removeClass("d-none");
  });

  // FILTER TOGGLE
  var listItems = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#item-list li");
  var toggleLink = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#toggle-link");
  ...
  // Increase quantity
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.increase-quantity').click(function () {
    var quantityElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.quantity-number').find('p');
    var quantity = parseInt(quantityElement.text());
    quantityElement.text(quantity + 1);
  });

  // Decrease quantity
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.decrease-quantity').click(function () {
    var quantityElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).siblings('.quantity-number').find('p');
    var quantity = parseInt(quantityElement.text());
    if (quantity > 1) {
      quantityElement.text(quantity - 1);
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".myCheckbox").change(function () {
  var isChecked = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).is(":checked");
  if (isChecked) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".myElement").removeClass("d-none");
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".myElement").addClass("d-none");
  }
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('select').each(function () {
  var $this = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this),
    selectOptions = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).children('option').length;
  $this.addClass('hide-select');
  $this.wrap('<div class="select"></div>');
  $this.after('<div class="custom-select"></div>');
  var $customSelect = $this.next('div.custom-select');
  $customSelect.text($this.children('option').eq(0).text());
  var $optionlist = jquery__WEBPACK_IMPORTED_MODULE_0___default()('<ul />', {
  ...
  $customSelect.click(function (e) {
    e.stopPropagation();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('div.custom-select.active').not(this).each(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('active').next('ul.select-options').hide();
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).toggleClass('active').next('ul.select-options').slideToggle();
  });
  $optionlistItems.click(function (e) {
    e.stopPropagation();
    $customSelect.text(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).text()).removeClass('active');
